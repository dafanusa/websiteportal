          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                ...
                <h4>Singang Bakar</h4>
                <p class="ingredients">
                  Ikan bakar khas dengan bumbu asam pedas Samawa
                </p>
                <p class="price">
                  Rp 18.000
                </p>
              ...
              <div class="col-lg-4 menu-item">
                ...
                <h4>Manjareal</h4>
                <p class="ingredients">
                  Kue tradisional berbahan beras & gula aren
                </p>
                <p class="price">
                  Rp 8.000
                </p>
              ...
              <div class="col-lg-4 menu-item">
                ...
                <h4>Kerupuk Kulit Sapi</h4>
                <p class="ingredients">
                  Gurih & renyah khas daerah Sumbawa
                </p>
                <p class="price">
                  Rp 12.000
                </p>
              ...
              <div class="col-lg-4 menu-item">
                ...
                <h4>Kacang Sira</h4>
                <p class="ingredients">
                  Kacang Goreng berbumbu khas Sumbawa
                </p>
                <p class="price">
                  Rp 7.000
                </p>
