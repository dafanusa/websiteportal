...
<script>
  function showSection(type) {
    ...
    const categoryButton = document.getElementById('nav-kategori');
    if (menuButton && categoryButton) {
      menuButton.classList.toggle('bg-maroon', type === 'menu');
      menuButton.classList.toggle('text-white', type === 'menu');
      menuButton.classList.toggle('text-slate-700', type !== 'menu');

      categoryButton.classList.toggle('bg-maroon', type === 'kategori');
      categoryButton.classList.toggle('text-white', type === 'kategori');
      categoryButton.classList.toggle('text-slate-700', type !== 'kategori');
    }
  }
